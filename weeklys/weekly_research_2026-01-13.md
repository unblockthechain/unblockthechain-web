...
2. **On-Chain Constructive Base**: Exchange supply neutral, whale transactions cooling (1k-10k BTC wallets), LTH accumulation + retail under 1 BTC buying; miner hash rate -4% m/m historically precedes +20-72% 90-180d returns[1][3][4]
...
- Tariff-driven inflation peak H1 2026 (2.75-3%) tests BTC hedge (0.10 corr vs breakeven)
- 81% coins red reflects risk-off, but Fear 26 creates entry
...
| LTH Accumulation | Positive | Retail under 1 BTC buying accelerates [1][3] |
...
**Important:** "Total APY" includes promotional incentives that may not persist. Base staking yield for ETH LSTs is ~2.5% as of 2026-01-13.
...
| **Risk** | **Trigger** | **Impact** |
| --- | --- | --- |
| **Miner Capitulation** | Hash rate down over 5% m/m | BTC support \$90K breaks, -10-15%[4] |
...
**Risk Management:** Trail stops to breakeven on longs; size positions under 2% risk; hedge with stablecoin allocation
...
- MVRV Z-Score below −15% extreme buy zone
